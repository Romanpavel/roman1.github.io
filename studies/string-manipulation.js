 ...
 *  STRING MANIPULATION:
 * 
 * 0. strings are anything we want to write between quotes, either "" or ''
 *
 * 1. this is very useful is javaScript as its a written language and makes naming things
 *    and referencing those things much easier sometimes we need to alter and
 *    access these strings, and there are several methods

 * 2. strings are indexed just like arrays where the first character is the [0] index
 *   
 * 3. strings are great ways for us to insert human language into the code
